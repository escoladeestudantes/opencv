#Usar
#python 01_FaceDetection_YOLO_v3_imagem.py
import numpy as np
import cv2
...
imagem = cv2.imread('PensadorBrazza.jpg')
boxes, confidences, classIDs, idxs = make_prediction(net, layer_names, imagem, 0.1, 0.3)
frame = draw_bounding_boxes(imagem, boxes, confidences, classIDs, idxs)
